# -*- coding: utf-8 -*-
"""
Created on Tue Jan 16 13:10:02 2024

@author: jim

MC_Policy_Gradient_Method
...
class ShortCorridor:
    def __init__(self):
        ...
        # s is arbitrary because definition
    ...
    def draw(self, avg, episode):
        x = np.arange(episode)
        y = avg
        plt.plot(x, y,color="red", label='MC_Policy_Gradient_Method')
    ...
    def run(self, episode):
        ...
        for i in range (0, episode):
            ...
            for h in history:
                ...
                self.theta += self.alpha * G * (self.x_s_a_minus_sum_of_prob_times_x_s_b(s_t, a_t))
                G -= r_t
            self.action_prob(0)
