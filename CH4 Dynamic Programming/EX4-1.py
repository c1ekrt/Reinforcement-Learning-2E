...
class State:
    ...
    def calculate_value(self, target):
        '''
        target:(int with two element [x,y])
        ...
        for move in self.valid_move:
            ...
            if self.ex_value[new_target[0]][new_target[1]] < 0:
                new_value += self.ex_value[new_target[0]][new_target[1]]
        return (new_value/4.0)+self.reward
...
x = State(4, 4, [[0,0],[3,3]], 10000, -1)
x.add_block_in_direction(1, "right")
'''
[[1. 0. 0. 0. 2.]
  [0. 0. 0. 0. 0.]
  [0. 0. 0. 0. 2.]
  [0. 0. 0. 1. 2.]]
'''
x.add_block_in_direction(0, "down")
'''
[[1. 0. 0. 0. 2.]
  [0. 0. 0. 0. 0.]
  [0. 0. 0. 0. 2.]
